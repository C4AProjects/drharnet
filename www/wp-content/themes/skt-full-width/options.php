...
function optionsframework_options() {
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => __('<a href="'.SKT_THEME_URL.'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="http://www.sktthemes.net/shop/skt_full_width_pro/">Buy PRO version for only $39 with more features and access to our support forum.</a></em></p>', 'skt-full-width'),
		'type' => 'info');	
